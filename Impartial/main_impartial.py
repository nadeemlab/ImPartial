...
if __name__== '__main__':
    ...
    if cparser.dataset == 'MIBI2CH':
        ...
        # files_scribbles = data_dir + 'files_2tasks1x2classes_scribble_train_' + cparser.scribbles + '.csv'
        # files_scribbles = data_dir + 'files_2tasks1x2classes_2train_scribble_train_' + cparser.scribbles + '.csv'
